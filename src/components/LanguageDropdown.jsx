...
const DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    title: {
      ...
      en: "30 Books on Building Wealth & Investing",
    },
    thumbnail: logo2,
  },
  {
    ...
    title: {
      ...
      en: "30 Parenting Guides for a Happy Family",
    },
    thumbnail: logo3,
  },
  {
          ...
          {data.map((b) => {
            ...
            return (
              ...
              <article
                key={b.id}
                className="
                  rounded-3xl overflow-hidden bg-white text-black
                  border-4 border-transparent
                  shadow-[0_10px_30px_rgba(0,0,0,0.06)]
                  transition-colors duration-300
                  hover:border-yellow-400 hover:ring-4 hover:ring-black/70
                "
                ...
                <div className="px-4 pb-4 pt-3">
                  ...
                  <button
                    ...
                    className="
                      ...
                      hover:bg-neutral-900 hover:text-white hover:border-yellow-400
